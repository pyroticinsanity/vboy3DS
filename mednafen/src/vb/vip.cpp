...
#elif BPP == 16
  static uint16 HLILUT[256];
  static uint16 ColorLUT[2][256];
  static uint16 BrightCLUT[2][4];
  static uint16 AnaSlowColorLUT[256][256];
#else 
  static uint8 HLILUT[256];
  static uint8 ColorLUT[2][256];
  static uint8 BrightCLUT[2][4];
  static uint8 AnaSlowColorLUT[256][256];
#endif
...
#endif
    const int32 pitch32 = surface->pitchinpix;
...
#else
        uint16 pixel = BrightCLUT[lr][source_bits & 3];
#endif
